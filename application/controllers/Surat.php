...
public function submit()
{
    ...
    $edited_item = [
        ...
        $this->session->set_flashdata('edited_item', $edited_item);
            redirect('list-surat-tugas');
        }
 ...
 // --- QR CODE GENERATE dengan versi checking ---
$qr_base64 = '';
try {
    if (extension_loaded('gd')) {
        // Cek apakah versi lama (1.x) atau baru (2.x/3.x)
        $reflection = new ReflectionClass('Endroid\QrCode\QrCode');
        $constructor = $reflection->getConstructor();
        $params = $constructor->getParameters();
        
        if (count($params) > 0 && $params[0]->getName() === 'text') {
            // Versi 1.x
    ...
    $qr_base64 = ''; // Fallback ke string kosong
}
