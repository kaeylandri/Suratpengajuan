...
<?php foreach ($surat->dosen_data as $i => $d): ?>
    <div style="margin-bottom: 12px; line-height: 1.5;">
        <span style="display:inline-block; width:85px;"><b>Nama</b></span> : <?= htmlspecialchars($d['nama']) ?><br>
        <span style="display:inline-block; width:85px;"><b>NIP</b></span> : <?= htmlspecialchars($d['nip']) ?><br>
        <span style="display:inline-block; width:85px;"><b>Jabatan</b></span> : <?= htmlspecialchars($d['jabatan']) ?><br>
    </div>
<?php endforeach; ?>
<?php else: ?>
...
<?php endif; ?>
   ...
   <p>
    sebagai  <b><?= $surat->jenis_penugasan_kelompok ?? '-' ?></b> di kegiatan <b><?= $surat->nama_kegiatan ?? '-' ?></b> 
