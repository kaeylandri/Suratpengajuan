                        ...
                        <tbody id="dosenTableBody">
                            <?php if (!empty($dosen_data)): ?>
                                <?php foreach ($dosen_data as $index => $dosen): ?>
                                    ...
                                    <tr class="dosen-row" data-index="<?= $index ?>">
                                        ...
                                        <td>
                                            <!-- NAMA DOSEN dengan autocomplete -->
                                            <input type="text" 
                                                   name="nama_dosen[]" 
                            ...
                            <?php else: ?>
                                <tr class="dosen-row" data-index="0">
                                    <td>
                                        <input type="text" name="nip[]" class="form-control form-control-sm nip-input" placeholder="Ketik NIP" required>
                                    </td>
                                    <td>
                                        <input type="text" name="nama_dosen[]" class="form-control form-control-sm nama-dosen-input" placeholder="Ketik Nama Dosen" required>
                                    </td>
                                    <td>
                                        <input type="text" name="jabatan[]" class="form-control form-control-sm jabatan-input" placeholder="Contoh: Lektor">
                                    </td>
                                    <td>
                                        <input type="text" name="divisi[]" class="form-control form-control-sm divisi-input" placeholder="Contoh: DI">
                                    </td>
                                    <td class="peran-column" style="<?= (isset($surat['jenis_pengajuan']) && $surat['jenis_pengajuan'] == 'Kelompok') ? '' : 'display:none;' ?>">
                                        <input type="text" name="peran[]" class="form-control form-control-sm peran-input" placeholder="Ketua/Anggota/dll">
                                    </td>
                                    <td>
                                        <button type="button" class="btn-remove-dosen" onclick="removeDosen(this)">
                                            <i class="fas fa-trash"></i> Hapus
