...
<style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    /* Catatan Penolakan Styles */
    .catatan-penolakan{background:#f8d7da;padding:12px;border-radius:6px;border-left:4px solid #e74c3c;margin-top:5px}
    .catatan-label{font-weight:600;color:#721c24;margin-bottom:5px;font-size:14px}
    .catatan-value{color:#721c24;font-size:14px;line-height:1.4}
</style>
</head>
<body>
...
<div class="container">
    ...
    <div class="debug-info">
        ...
        Status Filter: ditolak dekan<br>
        URL: <?= base_url('dekan/ditolak') ?>
    </div>
    ...
    const content = `
        <div>
            ...
            ${getVal('catatan_penolakan') && getVal('catatan_penolakan') !== '-' ? 
                `<div class="catatan-penolakan">
                    <div class="catatan-label">Alasan Penolakan:</div>
                    <div class="catatan-value">${escapeHtml(getVal('catatan_penolakan'))}</div>
                </div>` : 
                ''}
        </div>
    `;
