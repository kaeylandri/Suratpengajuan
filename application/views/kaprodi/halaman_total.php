...
<style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    /* Tombol Eviden - WARNA HIJAU (SAMA SEPERTI DASHBOARD) */
    .btn-eviden {
    ...
    /* Detail Content Styles - SAMA SEPERTI DASHBOARD */
    ...
    /* Dosen list in detail - SAMA SEPERTI DASHBOARD */
    .dosen-list {
        display: flex;
    ...
    /* File Evidence Styles - SAMA SEPERTI DASHBOARD */
    ...
    /* Preview Modal Styles - SAMA SEPERTI DASHBOARD */
    ...
    /* Action Buttons in Modal - SAMA SEPERTI DASHBOARD */
    ...
    /* Rejection Notes Styles - SAMA SEPERTI DASHBOARD */
    ...
    /* Surat Modal Styles (untuk lihat surat) */
    ...
    /* Responsive - SAMA SEPERTI DASHBOARD */
...
<div class="container">
    ...
    <div class="card">
        ...
        <!-- Form Filter -->
        <form method="get" action="<?= base_url('kaprodi/semua') ?>" id="filterForm">
            <div class="search-filter-container">
                ...
                <a href="<?= base_url('kaprodi/semua') ?>" class="btn-secondary">
        ...
        <div class="detail-content" style="padding:25px">
            ...
            <form id="approveForm" method="POST" action="">
                ...
                <div style="display:flex;justify-content:flex-end;gap:12px;margin-top:25px;padding-top:20px;border-top:1px solid #e9ecef">
                    <button type="button" class="btn" style="background:#95a5a6;color:white" onclick="closeModal('approveModal')">
...
// ============================================
// PREVIEW FILE FUNCTIONS - SAMA SEPERTI DASHBOARD
// ============================================
