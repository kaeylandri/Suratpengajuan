                        ...
                        <td onclick="event.stopPropagation()">
                            <div style="display:flex;gap:6px">
                                ...
                                <?php if($status == 'disetujui dekan'): ?>
                                    <button class="btn-nomor" 
                                            onclick="openNomorSuratModal(<?= $id ?>, '<?= htmlspecialchars(addslashes($nama_kegiatan)) ?>')"
                                ...
                                <?php if($status == 'disetujui dekan' && !empty($nomor_surat) && $nomor_surat !== '-' && $nomor_surat !== 'null'): ?>
                                    <button class="btn-cetak" 
                                            onclick="window.open('<?= site_url('sekretariat/cetak/' . $id) ?>', '_blank')"
                                            title="Cetak Surat">
...
<div id="pinModal" class="modal">
    <div class="modal-pin-box">
        <div class="modal-pin-title">
            <i class="fas fa-shield-alt"></i> Verifikasi PIN
        </div>
        ...
        <div class="modal-pin-buttons">
            <button class="btn-save" onclick="checkPin()">
                <i class="fas fa-check"></i> Lanjut
            </button>
            <button class="btn-cancel" onclick="closePinModal()">
        ...
        <div class="detail-content">
            ...
            <form id="nomorSuratForm">
                ...
                <div class="modal-actions">
                    <button type="button" class="modal-btn modal-btn-close" onclick="closeModal('nomorSuratModal')">
                        <i class="fa-solid fa-times"></i> Batal
                    </button>
                    <button type="submit" class="modal-btn" style="background:#3498db">
...
// ============================================
// FUNGSI NOMOR SURAT (SAMA DENGAN DASHBOARD)
// ============================================
...
async function openNomorSuratModal(id, namaKegiatan) {
    ...
    try {
        ...
        if (data.success) {
            ...
            document.getElementById('nomorSuratInfoBox').innerHTML = `
                <div style="background:#e8f6f3;border:1px solid #16A085;border-radius:8px;padding:15px;margin-bottom:20px">
