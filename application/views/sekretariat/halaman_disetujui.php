...
<style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .modal-header{background:#3498DB;color:white;padding:20px 25px;display:flex;justify-content:space-between;align-items:center;border-radius:15px 15px 0 0}
    ...
    .detail-section-title{font-size:16px;font-weight:700;color:#3498DB;margin-bottom:15px;padding-bottom:10px;border-bottom:2px solid #3498DB;display:flex;align-items:center;gap:10px}
    ...
    .file-item:hover{background:#e3f2fd;border-color:#3498DB}
    .file-icon{width:24px;height:24px;display:flex;align-items:center;justify-content:center;color:#3498DB;font-size:16px}
    .file-info{flex:1}
    ...
    .download-btn{background:#3498DB;color:white;border:none;padding:8px 16px;border-radius:6px;cursor:pointer;font-size:12px;font-weight:600;transition:background 0.2s;display:flex;align-items:center;gap:6px;text-decoration:none}
    .download-btn:hover{background:#2980b9;color:white;text-decoration:none}
    ...
    .preview-header{background:#3498DB;color:white;padding:15px 20px;display:flex;justify-content:space-between;align-items:center}
    ...
    .preview-unsupported i{font-size:48px;margin-bottom:15px;color:#3498DB}
    ...
    @media (max-width:768px){
        ...
        .status-header{flex-direction:column;text-align:center;gap:10px}
        .progress-track {
            flex-direction: column;
    ...
    <div class="card">
        ...
        <div class="search-container">
            ...
            <div class="search-box">
                ...
                <a href="<?= base_url('sekretariat/disetujui') ?>" class="btn-reset">
...
async function showDetail(id) {
    try {
        ...
        document.getElementById('detailContent').innerHTML = `
            <div style="text-align:center;padding:40px;">
                <i class="fa-solid fa-spinner fa-spin" style="font-size:24px;color:#3498DB"></i>
        ...
        if (status.toLowerCase() === 'disetujui dekan') {
            statusBadge = '<span class="badge badge-approved" style="margin-left:10px">Disetujui Dekan</span>';
        } else if (status.toLowerCase() === 'disetujui sekretariat') {
            statusBadge = '<span class="badge badge-sekretariat" style="margin-left:10px">Disetujui Sekretariat</span>';
