...
<div id="successRevisionModal" class="modal" onclick="modalClickOutside(event,'successRevisionModal')">
    <div class="bulk-modal-content" onclick="event.stopPropagation()" style="max-width: 600px;">
        ...
        <div style="padding:25px;text-align:center">
            ...
            <div style="display:flex;gap:10px;justify-content:center;margin-top:20px">
                <button class="btn-bulk" onclick="refreshPage()" style="background:#17a2b8;color:white;padding:10px 24px;border:none;border-radius:6px;cursor:pointer;font-weight:600;display:flex;align-items:center;gap:6px">
                    <i class="fa-solid fa-rotate"></i> Refresh Halaman
                </button>
                <button class="btn-bulk" onclick="closeModal('successRevisionModal')" style="background:#6c757d;color:white;padding:10px 24px;border:none;border-radius:6px;cursor:pointer;font-weight:600;display:flex;align-items:center;gap:6px">
                    <i class="fa-solid fa-times"></i> Tutup
                </button>
            </div>
        </div>
