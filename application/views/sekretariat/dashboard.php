...
<script>
    ...
    function approveSurat(id) {
        if (confirm('Apakah Anda yakin ingin menyetujui pengajuan ini?')) {
            ...
            window.location.href = '<?php echo base_url("sekretariat/approve/"); ?>' + id;
        }
    }
    ...
    function confirmReject() {
        ...
        form.method = 'POST';
        form.action = '<?php echo base_url("sekretariat/reject/"); ?>' + currentRejectId;
