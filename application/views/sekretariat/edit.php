    ...
    <style>
        * {
        ...
        .flatpickr-input:focus {
            ...
            box-shadow: 0 0 0 3px rgba(22, 160, 133, 0.2) !important;
        ...
        .flatpickr-day.inRange {
            ...
            border-color: rgba(22, 160, 133, 0.2) !important;
            box-shadow: -5px 0 0 rgba(22, 160, 133, 0.1), 5px 0 0 rgba(22, 160, 133, 0.1) !important;
        }
...
<body>
        ...
        <form action="<?= $form_action ?>" method="post" enctype="multipart/form-data" id="editForm">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    <label class="optional-field">Nomor Surat</label>
                    <input type="text" name="nomor_surat" class="form-control" value="<?= htmlspecialchars($surat['nomor_surat'] ?? ''); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="form-control" value="<?= htmlspecialchars($surat['nama_kegiatan'] ?? ''); ?>" required>
                </div>
                ...
                <!-- SECTION CUSTOM DATE -->
                <div id="custom_date_section" class="date-section <?= (isset($surat['jenis_date']) && $surat['jenis_date'] == 'Custom') ? 'active' : '' ?>">
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="tanggal_awal_kegiatan" name="tanggal_awal_kegiatan" 
                                       value="<?= htmlspecialchars($surat['tanggal_awal_kegiatan'] ?? '') ?>">
                                <input type="hidden" id="tanggal_akhir_kegiatan" name="tanggal_akhir_kegiatan"
                                       value="<?= htmlspecialchars($surat['tanggal_akhir_kegiatan'] ?? '') ?>">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    <label class="optional-field">Jenis Pengajuan</label>
                    <select name="jenis_pengajuan" id="jenis_pengajuan" class="form-control">
                        <option value="" disabled>Pilih Jenis Pengajuan (opsional)</option>
                ...
                <!-- Lingkup Penugasan -->
                <div class="form-group">
                    <label class="optional-field">Lingkup Penugasan</label>
                    <select name="lingkup_penugasan" id="lingkup_penugasan" class="form-control">
                        <option value="" disabled>Pilih Lingkup Penugasan (opsional)</option>
                ...
                <div id="jenis_penugasan_perorangan_container" style="<?= (isset($surat['jenis_pengajuan']) && $surat['jenis_pengajuan'] == 'Perorangan') ? '' : 'display:none;'; ?>">
                    <div class="form-group">
                        <label class="optional-field">Jenis Penugasan (Perorangan)</label>
                        <select name="jenis_penugasan_perorangan" id="jenis_penugasan_perorangan" class="form-control">
                            <option value="" disabled>Pilih Jenis Penugasan (opsional)</option>
                            <?php 
                    ...
                    <div class="form-group" id="penugasan_lainnya_perorangan_container" style="<?= (isset($surat['jenis_penugasan_perorangan']) && $surat['jenis_penugasan_perorangan'] == 'Penugasan Lainnya') ? '' : 'display:none;'; ?>">
                        <label class="optional-field">Isi Penugasan Lainnya</label>
                        <input type="text" name="penugasan_lainnya_perorangan" id="penugasan_lainnya_perorangan" 
                               class="form-control" value="<?= htmlspecialchars($surat['penugasan_lainnya_perorangan'] ?? ''); ?>">
                    </div>
                </div>
                ...
                <div id="jenis_penugasan_kelompok_container" style="<?= (isset($surat['jenis_pengajuan']) && $surat['jenis_pengajuan'] == 'Kelompok') ? '' : 'display:none;'; ?>">
                    <div class="form-group">
                        <label class="optional-field">Jenis Penugasan (Kelompok)</label>
                    ...
                    <div class="form-group" id="penugasan_lainnya_kelompok_container" style="<?= (isset($surat['jenis_penugasan_kelompok']) && $surat['jenis_penugasan_kelompok'] == 'Penugasan Lainnya') ? '' : 'display:none;'; ?>">
                        ...
                        <input type="text" name="penugasan_lainnya_kelompok" id="penugasan_lainnya_kelompok" 
                               class="form-control" value="<?= htmlspecialchars($surat['penugasan_lainnya_kelompok'] ?? ''); ?>">
                    </div>
                </div>
            </div>

            <!-- Dosen Terkait Section - SEMUA FIELD OPSIONAL -->
            <div class="form-section">
                <h5><i class="fas fa-users"></i> Dosen Terkait <small style="font-size: 12px; color: #6c757d; font-weight: normal;">(Opsional)</small></h5>
                
                <div class="table-responsive">
                    <table class="table-dosen">
                        <thead>
                            <tr>
                                <th>NIP <small>(opsional)</small></th>
                                <th>Nama Dosen <small>(opsional)</small></th>
                                <th>Jabatan <small>(opsional)</small></th>
                                <th>Divisi <small>(opsional)</small></th>
                                <th>Peran <small>(opsional)</small></th>
                                <th>Aksi</th>
                            </tr>
                        </thead>
                ...
                <button type="button" class="btn-add-dosen" onclick="addDosenRow()">
                    <i class="fas fa-plus"></i> Tambah Dosen (Opsional)
                </button>
            </div>

            <!-- File Eviden - SEMUA OPSIONAL -->
            <div class="form-section">
                <h5><i class="fas fa-file-alt"></i> File Eviden <small style="font-size: 12px; color: #6c757d; font-weight: normal;">(Opsional)</small></h5>
                
                <div style="margin-bottom: 20px;">
                    <label style="display: block; font-weight: 600; margin-bottom: 10px; color: #333;">
                        <i class="fas fa-cloud-upload-alt"></i> Upload File Eviden (Opsional)
                    </label>
                    <p style="font-size: 13px; color: #6c757d; margin-bottom: 15px;">
                        Anda dapat menambah atau menghapus file eviden yang sudah diupload. Field ini opsional.
                    </p>
                ...
                <div style="margin-bottom: 20px;">
                    <button type="button" id="upload-btn" class="btn btn-primary" 
                            style="padding: 10px 20px; border-radius: 8px; background: #007bff; border: none; color: white; cursor: pointer; font-weight: 500; display: inline-flex; align-items: center; gap: 8px;">
                    ...
                    <span id="file-count-indicator" style="margin-left: 15px; font-size: 14px; color: #6c757d;">
                        <i class="fas fa-file"></i> <span id="current-file-count"><?= count($existing_files) ?></span> file tersedia (opsional)
                    </span>
                </div>
                ...
                <div id="uploaded-files-display" style="<?= count($existing_files) > 0 ? '' : 'display:none;' ?>">
                    <div style="background: #f8f9fa; border-radius: 8px; padding: 15px; border: 1px solid #dee2e6;">
                        <h6 style="font-weight: 600; margin-bottom: 10px; color: #495057;">
                            <i class="fas fa-check-circle" style="color: #28a745;"></i> File yang sudah diupload (Opsional) (<span id="total-files"><?= count($existing_files) ?></span>):
                        </h6>
                        <div id="files-list">
    ...
    function getFileIcon($url) {
        ...
        return '<i class="fas ' . $icon . '" style="font-size: 20px; color: #138D75;"></i>';
    }
    ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // ========================================
            // 1. TANGGAL KEGIATAN FUNCTIONALITY (SEMUA OPSIONAL)
            // ========================================
            ...
            // Inisialisasi flatpickr TANPA validasi wajib
            ...
            // ========================================
            // 3. DOSEN TERKAIT FUNCTIONALITY (SEMUA OPSIONAL)
            // ========================================
            ...
            window.removeDosen = function(button) {
                ...
                setTimeout(() => {
                    ...
                    if (tbody.querySelectorAll('tr.dosen-row').length === 0) {
                        ...
                        emptyRow.innerHTML = '<td colspan="6" class="text-center text-muted">Belum ada dosen terkait (opsional)</td>';
            ...
            // ========================================
            // 4. FILE EVIDEN FUNCTIONALITY (SEMUA OPSIONAL)
            // ========================================
            ...
            // Update button state (TANPA validasi wajib)
            function updateButtonState() {
                ...
                if (fileCount > 0) {
                    ...
                    validationText.textContent = `${fileCount} file telah diupload (opsional).`;
                    validationMessage.className = "validation-message info";
                    validationMessage.style.display = 'flex';
                } else {
                    uploadedDisplay.style.display = 'none';
                    validationText.textContent = "Belum ada file diupload (field ini opsional).";
                    validationMessage.className = "validation-message info";
                    validationMessage.style.display = 'flex';
                }
                    ...
                    files.forEach((filePromise, index) => {
                        filePromise.done(fileInfo => {
                            ...
                            if (processedFiles === totalFiles) {
                                ...
                                validationText.textContent = `✓ ${totalFiles} file berhasil ditambahkan! (opsional)`;
            ...
            function highlightMatch(text, query) {
                ...
                return text.replace(regex, '<span style="color: #16A085; font-weight: bold;">$1</span>');
            }
            ...
            async function fetchSuggestions(query, fieldType = 'nip') {
                ...
                try {
                    if (fieldType !== 'nip' && fieldType !== 'nama_dosen' && fieldType !== 'jabatan' && fieldType !== 'divisi') {
                        return [];
                    }
                ...
                items.forEach((item, idx) => {
                    ...
                    option.innerHTML = `
                        <div style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; cursor: pointer; transition: background 0.2s;">
                            <div style="width: 20px; height: 20px; color: #16A085;">
            ...
            // ========================================
            // 7. FORM SUBMIT VALIDATION - TANPA VALIDASI WAJIB
            // ========================================
            
            document.getElementById('editForm').addEventListener('submit', function(e) {
                // HAPUS SEMUA VALIDASI WAJIB
                // Form bisa disubmit meskipun semua field kosong
                // Hanya validasi server-side yang akan berlaku
                
                // Hanya validasi nama kegiatan saja (jika ada)
